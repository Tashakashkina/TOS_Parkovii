# Приложение Flutter для ТОС "Парковый"
Приложение для территориального органа самоуправления "Парковый". Создавалось для жителей микрорайона и управленцев: информационная поддержка жильцов, справки и новости.
